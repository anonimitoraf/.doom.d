...
(use-package doom-themes
  ...
  (custom-set-faces!
    ...
    `(corfu-current :background "grey15" :foreground ,(doom-color 'green))
    `(orderless-match-face-0 :inherit corfu-current :background nil :foreground "#7bb6e2")
    `(orderless-match-face-1 :inherit corfu-current :background nil :foreground "#c195d7")
    `(orderless-match-face-2 :inherit corfu-current :background nil :foreground "#d8bf9c")
    `(orderless-match-face-3 :inherit corfu-current :background nil :foreground "#a5bf8f")
