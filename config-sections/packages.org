...
#+end_src
# Disable dap-mode for now. I get this error otherwise: "No buffer named *doom*"
# * =dap=
...
Allow usage of evil in minibuffer
#+begin_src elisp
...
TODO: Find a way to disable/enable LSP completion based on the lang (I don't want it for Clojure/script but I want it for any other lang)
#+begin_src elisp
(after! lsp-mode
...
#+end_src
Disable flycheck popups because they make Emacs lag
#+begin_src elisp
